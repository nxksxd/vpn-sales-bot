...
@router.callback_query(F.data.in_({"adm:bc_all", "adm:bc_active", "adm:bc_expiring", "adm:bc_new", "adm:bc_trial", "adm:bc_inactive"}))
@admin_only
async def cb_broadcast_target(call: CallbackQuery, state: FSMContext) -> None:
    ...
    target_names = {
        ...
        "adm:bc_new": "новым пользователям (7 дней)",
        "adm:bc_trial": "без trial",
        "adm:bc_inactive": "неактивным пользователям",
    }
