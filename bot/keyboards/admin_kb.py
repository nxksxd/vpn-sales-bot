...
def admin_xui_settings_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="🌐 Изменить URL", callback_data="adm:set:xui_url")],
            [InlineKeyboardButton(text="👤 Изменить логин", callback_data="adm:set:xui_username")],
            [InlineKeyboardButton(text="🔑 Изменить пароль", callback_data="adm:set:xui_password")],
            [InlineKeyboardButton(text="📡 Изменить Inbound ID", callback_data="adm:set:xui_inbound_id")],
            [InlineKeyboardButton(text="🖥 Изменить адрес сервера", callback_data="adm:set:server_address")],
            [InlineKeyboardButton(text="🌍 Регионы серверов", callback_data="adm:regions")],
            [InlineKeyboardButton(text="🎁 Промокоды", callback_data="adm:promos")],
            [InlineKeyboardButton(text="🔍 Проверить подключение", callback_data="adm:set:test")],
            [InlineKeyboardButton(text="« Админ-панель", callback_data="adm:main")],
        ]
    )
